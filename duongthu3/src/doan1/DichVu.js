  ...
  return (
    <div>
      <ul className="h-card hidden">
        <li className="h-fn fn">Dalhye Beauty</li>
        <li className="h-org org">Dalhye Beauty</li>
        <li className="h-tel tel">02466809066</li>
        <li>
          <a className="u-url ul" href="https://dalhyebeauty.vn/">
            https://dalhyebeauty.vn/
          </a>
        </li>
      </ul>
      ...
      <div className="menu">
        <div className="wrap-content d-flex align-items-center justify-content-end">
          <a className="logo-header" href="">
            <img
              onerror="this.src='thumbs/120x120x2/assets/images/noimage.png';"
              src="upload/photo/dalhyebeauty-3868.png"
            />
          </a>
          <ul className="d-flex align-items-center justify-content-end">
            <li>
              <a className="transition " href="gioi-thieu" title="Giới thiệu">
                <h2>Giới thiệu</h2>
              </a>
            </li>
            <li>
              <a className="transition active" href="dich-vu" title="Dịch vụ">
                <h2>Dịch vụ</h2>
              </a>
            </li>
            <li>
              <a className="transition " href="khuyen-mai" title="Khuyến mãi">
                <h2>Khuyến mãi</h2>
              </a>
            </li>
            <li>
              <a className="transition " href="shop" title="Shop">
                <h2>Shop</h2>
              </a>
            </li>
            <li>
              <a className="transition " href="tin-tuc" title="Tin tức">
                <h2>Tin tức</h2>
              </a>
            </li>
            <li>
              <a className="transition " href="lien-he" title="Liên hệ">
                <h2>Liên hệ</h2>
              </a>
            </li>
          </ul>
          <div className="search-rp">
            ...
            <div className="search-menu w-clear">
              ...
              />
              <a className="btn-s-rp" onclick="onSearch();">
      ...
      <div className="menu-res">
        <div className="menu-bar-res">
          ...
          <div className="search-res">
            <p className="icon-search transition">
      ...
      <div className="wrap-main  w-clear">
        ...
        <div className="content-main w-clear">
          <a
            className="news text-decoration-none w-clear"
            href="waxing"
            title="WAXING "
          >
            <p className="pic-news scale-img">
              <img
                onerror="this.src='thumbs/320x240x2/assets/images/noimage.png';"
                src="thumbs/320x240x1/upload/news/waxing-7602.png"
                alt="WAXING "
              />
            </p>
          ...
          >
            <p className="pic-news scale-img">
              <img
                onerror="this.src='thumbs/320x240x2/assets/images/noimage.png';"
                src="thumbs/320x240x1/upload/news/foot-7710.png"
                alt="FOOT CARE  "
              />
            </p>
            <div className="info-news">
              ...
              <div className="desc-news text-split">
          ...
          <a
            className="news text-decoration-none w-clear"
            href="dich-vu-bom-moi"
            title="DƯỠNG  SINH  "
          >
            <p className="pic-news scale-img">
              <img
                onerror="this.src='thumbs/320x240x2/assets/images/noimage.png';"
                src="thumbs/320x240x1/upload/news/z4429906231918253f508be7676dba0726a5b7c47cfc2a-4076.jpg"
                alt="DƯỠNG  SINH  "
              />
            </p>
            <div className="info-news">
          ...
          >
            <p className="pic-news scale-img">
              <img
                onerror="this.src='thumbs/320x240x2/assets/images/noimage.png';"
                src="thumbs/320x240x1/upload/news/skin-9076.png"
                alt="SKIN  TREATMENT  "
              />
            </p>
            <div className="info-news">
              ...
              <p className="time-news">Ngày đăng: 11/06/2023 11:14 PM</p>
              <div className="desc-news text-split">MÔ TẢ NGẮNN</div>
            </div>
          </a>
          <a
            className="news text-decoration-none w-clear"
          ...
          >
            <p className="pic-news scale-img">
              <img
                onerror="this.src='thumbs/320x240x2/assets/images/noimage.png';"
                src="thumbs/320x240x1/upload/news/eysslash-7799.png"
                alt="EYELASHES"
              />
            </p>
            <div className="info-news">
          ...
          >
            <p className="pic-news scale-img">
              <img
                onerror="this.src='thumbs/320x240x2/assets/images/noimage.png';"
                src="thumbs/320x240x1/upload/news/1-5710.png"
                alt="NAILS"
              />
            </p>
            <div className="info-news">
          ...
          <div className="wrap-content d-flex align-items-start justify-content-between">
            <div className="footer-news">
              ...
              <div className="info-footer">
                <p>
                  Địa chỉ: số 80 Nguyễn Hữu Huân, Phường Lý Thái Tổ, Quận Hoàn
                  kiếm, Hà Nội
                </p>
              ...
              <ul className="social social-footer">
                <li>
                  <a href="" target="_blank">
                    <img src="upload/photo/mxh3-1-5052.png" alt="" />
                  </a>
                </li>
                <li>
                  <a href="" target="_blank">
                    <img src="upload/photo/mxh3-2-2182.png" alt="" />
                  </a>
                </li>
                <li>
                  <a href="" target="_blank">
                    <img src="upload/photo/mxh3-3-5405.png" alt="" />
                  </a>
                </li>
                <li>
                  <a href="" target="_blank">
                    <img src="upload/photo/mxh3-4-9673.png" alt="" />
                  </a>
                </li>
              </ul>
              <div className="info-footer">
      ...
      <a
        className="cart-fixed text-decoration-none"
        href="gio-hang"
        title="Giỏ hàng"
      >
      ...
      <a
        className="btn-zalo btn-frame text-decoration-none"
        target="_blank"
        href="https://zalo.me/0789422594"
      >
      ...
      >
        <div className="modal-dialog modal-dialog-top modal-lg" role="document">
          <div className="modal-content">
            <div className="modal-header">
              <h6 className="modal-title" id="popup-cart-label">
                Giỏ hàng của bạn
              </h6>
              <button
                type="button"
